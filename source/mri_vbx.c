//mri.c benchmark implemented on the vbx 
...
vbx_word_t *vt1 = vbx_sp_malloc(M*sizeof(vbx_word_t));
vbx_word_t *vt2 = vbx_sp_malloc(M*sizeof(vbx_word_t));
...
vbx( VVW,VOR,vtemp1,vi_9,vi_10);
vbx( VVW,VMUL,vtemp2,vi_0,vi_1);
vbx( VVW,VMUL,vt1,vi_2,vi_3);
vbx( VVW,VMUL,vt2,vi_4,vi_5);
vbx( VVW,VADD,vt1,vt1,vt2);
vbx( VVW,VADD,vtemp2,vtemp2,vt1);
vbx( VVW,VMUL,vtemp2,vtemp2,vi_6);


vbx( VVW,VADD,vo_0,vtemp2,vi_7);
vbx( VVW,VMUL,vo_0,vo_0,vtemp1);

vbx( VVW,VADD,vo_1,vtemp2,vi_8);
vbx( VVW,VMUL,vo_1,vo_1,vtemp1);
