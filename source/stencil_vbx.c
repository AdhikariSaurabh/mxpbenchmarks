//stencil.c benchmark implemented on the vbx 
...
vbx_word_t *vi_6 = vbx_sp_malloc(M*sizeof(vbx_word_t));
vbx_word_t *vi_7 = vbx_sp_malloc(M*sizeof(vbx_word_t));
vbx_word_t *vi_8 = vbx_sp_malloc(M*sizeof(vbx_word_t));
vbx_word_t *vi_9 = vbx_sp_malloc(M*sizeof(vbx_word_t));
vbx_word_t *vi_10 = vbx_sp_malloc(M*sizeof(vbx_word_t));
vbx_word_t *vi_11 = vbx_sp_malloc(M*sizeof(vbx_word_t));
vbx_word_t *vi_12 = vbx_sp_malloc(M*sizeof(vbx_word_t));
vbx_word_t *vi_13 = vbx_sp_malloc(M*sizeof(vbx_word_t));
...
vbx( VVW,VADD,vo_0,vi_0,vi_1);
vbx( VVW,VADD,vo_0,vo_0,vi_2);
vbx( VVW,VADD,vo_0,vo_0,vi_3);
vbx( VVW,VADD,vo_0,vo_0,vi_4);
vbx( VVW,VADD,vo_0,vo_0,vi_3);
vbx( VVW,VMUL,vo_0,vo_0,vi_6);
vbx( VVW,VSUB,vo_0,vo_0,vi_7);

vbx( VVW,VADD,vo_1,vi_8,vi_9);
vbx( VVW,VADD,vo_1,vo_1,vi_10);
vbx( VVW,VADD,vo_1,vo_1,vi_11);
vbx( VVW,VADD,vo_1,vo_1,vi_12);
vbx( VVW,VADD,vo_1,vo_1,vi_13);
vbx( VVW,VMUL,vo_1,vo_1,vi_6);
vbx( VVW,VSUB,vo_1,vo_1,vi_15);
