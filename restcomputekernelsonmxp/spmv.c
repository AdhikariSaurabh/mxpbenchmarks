...
vbx( VVB,VMUL,vtemp1,vi_0,vi_1);
vbx( VVB,VMUL,vtemp2,vi_2,vi_3);
vbx( VVB,VADD,vtemp2,vtemp1,vtemp2);
vbx( VVB,VMUL,vtemp3,vi_4,vi_5);
vbx( VVB,VADD,vtemp3,vtemp2,vtemp3);

vbx( VVB,VMUL,vtemp4,vi_8,vi_9);
vbx( VVB,VMUL,vtemp5,vi_10,vi_11);
vbx( VVB,VADD,vtemp5,vtemp4,vtemp5);
vbx( VVB,VMUL,vtemp6,vi_12,vi_13);
vbx( VVB,VADD,vtemp6,vtemp5,vtemp6);

vbx( VVB,VMUL,vo_0,vi_6,vi_7);
vbx( VVB,VADD,vo_0,vo_0,vtemp3);
vbx( VVB,VMUL,vo_1,vi_14,vi_15);
vbx( VVB,VADD,vo_1,vo_1,vtemp6);
...
printf("Maximum Throughput on MXP for spmv kernel in (Gops/sec) is -> %g Gops/sec\n",(N*M*ops)/(seconds*pow(10,9))); 
