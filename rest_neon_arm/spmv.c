...
x11=(int8_t *)malloc(N*sizeof(int8_t));
x12=(int8_t *)malloc(N*sizeof(int8_t));
x13=(int8_t *)malloc(N*sizeof(int8_t));
...
for(i=0;i<N;i++){
temp1=x0[i] * x1[i];
temp2=x2[i] * x3[i] + temp1;
temp3=x4[i] * x5[i] + temp2;
temp4=x8[i] * x9[i];
temp5=x10[i] * x11[i] + temp4;
temp6=x12[i] * x13[i] + temp5;

y0[i]=x6[i]*x7[i]+ temp3;
y1[i]=x14[i]*x15[i]+ temp6;
}
